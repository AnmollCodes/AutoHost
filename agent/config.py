"""Centralized configuration for AutoHost using Pydantic Settings."""
...
class Settings(BaseSettings):
    ...
    AUTOHOST_ prefix. For example:
        AUTOHOST_OLLAMA_MODEL=llama2
        AUTOHOST_SANDBOX_TIMEOUT=60
    """

    model_config = SettingsConfigDict(
        env_prefix="AUTOHOST_",
        env_file=".env",
    ...
    max_tokens: int = 8192
    num_ctx: int = 32768  # Context window size (increase for longer prompts)
    ...
    workspace_dir: str = "~/.autohost/workspaces"
    task_history_file: str = "~/.autohost/task_history.json"
    db_file: str = "~/.autohost/autohost.db"  # SQLite database path
