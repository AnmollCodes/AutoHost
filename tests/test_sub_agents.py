...
class TestSubAgentIntegration:
    ...
    @pytest.mark.asyncio
    @pytest.mark.asyncio
    async def test_full_parallel_flow(self, agent):
        ...
        responses = [
            ...
            },
            {
                "thought": "Search done",
                "is_complete": True,
                "response": "Found results for search 1",
            },
            {
                "thought": "Search done",
                "is_complete": True,
                "response": "Found results for search 2",
            },
            {
                "success": True,
    ...
    async def test_progress_callback_receives_parallel_status(self, mock_sandbox):
        ...
        responses = [
            {
                "thought": "Task 1",
                "is_complete": False,
                "action": {"tool": "shell", "args": {"command": "echo Task1"}},
            },
            {
                "thought": "Task 2",
                "is_complete": False,
                "action": {"tool": "shell", "args": {"command": "echo Task2"}},
            },
        ...
        # Just ensure the agent ran and returned a result
        assert state.final_answer is not None
